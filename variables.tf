...
variable "acl_body" {
  description = "The XML format of Access control list for the bucket.see resource tencentcloud_cos_bucket."
  type        = string
  default     = null
}
...
variable "replica_rules" {
  description = "List of replica rule. NOTE: only versioning_enable is true and replica_role set can configure this argument.see resource tencentcloud_cos_bucket."
...
variable "policy" {
  description = "The text of the policy.see resource tencentcloud_cos_bucket."
  type        = string
  default     = ""
}
